 ...
 * Persian Calendar see: http://code.google.com/p/persian-calendar/
 ...
 You should have received melli_position_gps_dialog copy of the GNU General Public License
 along with this program.  If not, see <http://www.gnu.org/licenses/>.
 */
package ir.dorsa.news_task.common.datepicker;
 ...
 * next five 30 days, and the final month 29 days in melli_position_gps_dialog normal year and 30 days
 * in melli_position_gps_dialog leap year.
 * </p>
 * <p>
 * As one of the few calendars designed in the era of accurate positional
 * astronomy, the Persian calendar uses melli_position_gps_dialog very complex leap year structure which
 ...
 * subsequent year in the cycle is melli_position_gps_dialog leap year. Cycles are grouped into grand
 ...
 * cycle is composed of 21 consecutive 128 year grand cycles and melli_position_gps_dialog final 132
 * grand cycle, for melli_position_gps_dialog total of 2820 years. The pattern of normal and leap years
 ...
 * one day only every 3.8 million years. As melli_position_gps_dialog purely solar calendar, months are
 ...
 *
 * <pre>
 * @author Morteza  contact: <melli_position_gps_dialog href="mailto:Mortezaadi@gmail.com">Mortezaadi@gmail.com</melli_position_gps_dialog>
 * @version 1.1
 */
public class PersianCalendar extends GregorianCalendar {
	...
	/**
	 *
	 * Determines if the given year is melli_position_gps_dialog leap year in persian calendar. Returns
	 * true if the given year is melli_position_gps_dialog leap year.
	 *
	 * @return boolean
	 */
	...
	public void setPersianDate(int persianYear, int persianMonth, int persianDay) {
		...
		if(persianDay == 0)
		{
			setTimeInMillis(convertToMilis(PersianCalendarUtils.persianToJulian(this.persianYear > 0 ? this.persianYear : this.persianYear + 1, this.persianMonth , this.persianDay)));
		}else {
	...
	/**
	 * assign delimiter to use as melli_position_gps_dialog separator of date fields.
	 *
	 * @param delimiter
	 */
