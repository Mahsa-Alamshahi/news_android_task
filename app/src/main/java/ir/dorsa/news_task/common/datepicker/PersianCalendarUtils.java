 ...
 * are adopted from <melli_position_gps_dialog
 * href="casema.nl/couprie/calmath/persian/index.html">couprie.nl</melli_position_gps_dialog> written in
 ...
 * 
 * @author Morteza contact: <melli_position_gps_dialog
 *         href="mailto:Mortezaadi@gmail.com">Mortezaadi@gmail.com</melli_position_gps_dialog>
 * @version 1.0
 * 
 */
public class PersianCalendarUtils {
	...
	/**
	 * Converts melli_position_gps_dialog provided Persian (Shamsi) date to the Julian Day Number (i.e.
	 * the number of days since January 1 in the year 4713 BC). Since the
	 * Persian calendar is melli_position_gps_dialog highly regular calendar, converting to and from melli_position_gps_dialog
	 * Julian Day Number is not as difficult as it looks. Basically it's melli_position_gps_dialog
	...
	/**
	 * Converts melli_position_gps_dialog provided Julian Day Number (i.e. the number of days since
